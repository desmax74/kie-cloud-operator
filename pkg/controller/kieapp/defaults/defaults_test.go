...
func TestRhdmEnvironmentWithKafkaExt(t *testing.T) {
	...
	assert.Nil(t, err, "Error getting prod environment")
	assert.NotNil(t, env)
	assert.True(t, len(cr.Spec.Objects.Servers[0].Kafka.Topics) == 2)
